        ...
        <div className="-mx-3 flex flex-wrap justify-center mb-12">
          ...
          <div className="p-3 w-full md:w-6/12 lg:w-4/12">
            <div className="bg-white border shadow-md text-gray-500 rounded-lg">
              <a href="/">
                <img
                  src="/images/sight01-eiffel.webp"
              ...
              <div className="p-6">
                ...
                <p className="mb-2 text-sm">Description of Sight 01</p>
          ...
          <div className="p-3 w-full md:w-6/12 lg:w-4/12">
            <div className="bg-white border shadow-md text-gray-500 rounded-lg">
              <a href="/">
                <img
                  src="images/sight02-chinese-wall.webp"
              ...
              <div className="p-6">
                ...
                <p className="mb-2 text-sm">Description of Sight 02</p>
                <hr className="border-gray-200 my-4" />
                <div className="flex items-center justify-between">
          ...
          <div className="p-3 w-full md:w-6/12 lg:w-4/12">
            <div className="bg-white border shadow-md text-gray-500 rounded-lg">
              <a href="/">
                <img
                  src="images/sight03-sydney-opera.webp"
                  className="hover:opacity-90 w-full rounded-t-md"
              ...
              <div className="p-6">
                ...
                <p className="mb-2 text-sm">Description of Sight 03</p>
                <hr className="border-gray-200 my-4" />
                <div className="flex items-center justify-between">
